...
import { Card, Button, SearchComponent, NoteCard, showNotification } from '../components/ui';
      ...
      if (savedNotes) {
        ...
        if (updatedNote) {
          showNotification.success(
            updatedNote.isFavorite ? 'Добавлено в избранное' : 'Удалено из избранного'
          );
        }
      }
    } catch (error) {
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4 text-sm text-text-secondary dark:text-dark-text-secondary">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Избранных: {notes.filter(n => n.isFavorite).length}</span>
              </div>
