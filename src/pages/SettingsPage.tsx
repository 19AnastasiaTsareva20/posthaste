    ...
    reader.onload = (e) => {
      try {
        ...
        if (importData.folders) {
          localStorage.setItem(
            "notesflow-folders",
            JSON.stringify(importData.folders),
          );
        }
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateSetting("showPreview", e.target.checked)
                    }
                    className="rounded border-border focus:ring-primary"
                  />
                </div>
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={(e) =>
                    updateSetting("exportFormat", e.target.value as any)
                  }
                  className="input w-full"
                >
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <p className="text-sm text-text-secondary dark:text-dark-text-secondary">
                Восстановить все настройки до значений по умолчанию. Ваши
                заметки не будут удалены.
              </p>
