  ...
  return (
    <>
            ...
            {navigationItems.map((item) => (
              ...
              >
                <span className={`transition-colors ${
                  isCurrentPath(item.path) ? 'text-white' : 'text-primary dark:text-night-primary'
                }`}>
                  {item.icon}
                </span>
      ...
      <div className="md:hidden">
        ...
        >
          {isMenuOpen ? (
            <svg className="h-6 w-6 text-text-primary dark:text-dark-text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
