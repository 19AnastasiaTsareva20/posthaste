    ...
    <div className="flex items-center gap-2">
      ...
      >
        {theme === 'light' ? (
          ...
          <svg className="w-5 h-5 text-text-primary dark:text-dark-text-primary group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 20 20">
            <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
          </svg>
        ) : (
          // Иконка солнца для светлой темы / Sun icon for light theme
          <svg className="w-5 h-5 text-text-primary dark:text-dark-text-primary group-hover:text-white transition-colors animate-spin-slow" fill="currentColor" viewBox="0 0 20 20">
      ...
      >
        <svg className={`w-5 h-5 transition-colors ${
          readingMode ? 'text-white' : 'text-text-primary dark:text-dark-text-primary group-hover:text-white'
